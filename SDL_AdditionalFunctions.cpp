...
unordered_map<char, SDL_Texture*> SDL_Extras::SDL_GetTexturesFromString(SDL_Renderer* rend, string aString, TTF_Font* font)
{
...
void SDL_Extras::SDL_RenderStringAt(SDL_Renderer* rend, string text, SDL_Point p, unordered_map<char, SDL_Texture*> chars, Uint16 size, SDL_Rect* clipRect)
{
